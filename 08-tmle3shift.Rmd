...
```{r, fig.cap="Animation of how a counterfactual outcome changes as the natural treatment distribution is subjected to a simple stochastic intervention", echo=FALSE, fig.show = 'hold'}
...
```{r washb-data-npsem-shift, message=FALSE, warning=FALSE}
node_list <- list(
