...
```{r fit_tmle-shift, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r fit_tmle_wrapper_vimshift, message=FALSE, warning=FALSE, cache=TRUE}
tmle_fit <- tmle3(tmle_spec, data, node_list, learner_list)
tmle_fit
```
...
```{r vim_targeted_msm_fit, message=FALSE, warning=FALSE, cache=TRUE}
# initialize a tmle specification
...
```{r load-washb-data-shift, message=FALSE, warning=FALSE}
...
```{r shift_spec_emm_washb, message=FALSE, warning=FALSE, cache = TRUE}
...
```{r fit_shift_emm_washb, message=FALSE, warning=FALSE, cache = TRUE}
# fit stratified TMLE
...
```{r vim_spec_init_washb, message=FALSE, warning=FALSE, cache = TRUE}
...
```{r fit_tmle_wrapper_washb, message=FALSE, warning=FALSE, cache = TRUE}
