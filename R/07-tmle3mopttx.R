## ---- fig.cap="Illustration of a Dynamic Treatment Regime in a Clinical Setting", echo=FALSE----
...
## ----load-washb-data, message=FALSE, warning=FALSE,eval=FALSE-----------------
...
## ----washb-data-npsem-mopttx, message=FALSE, warning=FALSE, eval=FALSE--------
## node_list <- list(
