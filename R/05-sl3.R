...
## ----list-properties, message=FALSE, warning=FALSE----------------------------
sl3_list_properties()


## ----list-learners, message=FALSE, warning=FALSE------------------------------
sl3_list_learners(c("binomial"))


## ----baselearners, message=FALSE, warning=FALSE-------------------------------
...
## ----extra-lrnr-mindblown, eval = FALSE---------------------------------------
...
## ----sl-basic, message=FALSE, warning=FALSE-----------------------------------
sl_fit <- sl$train(ist_task)


## ----sl-basic-summary, message=FALSE, warning=FALSE---------------------------
sl_preds <- sl_fit$predict()
head(sl_preds)
sl_fit$print()


## ----CVsl, message=FALSE, warning=FALSE---------------------------------------
