...
Before installing packages, please [update your version of 
...
This workshop has other dependencies, which you can install using the following
linked script:

* [install.R](https://github.com/tlverse/gates2019-workshop/blob/master/install.R)
