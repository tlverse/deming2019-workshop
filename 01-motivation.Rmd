...
Our objective is to provide training to students, researchers, industry 
professionals, faculty in science, public health, statistics, and other
...
For introductory materials for learning the `R` programming language we 
recommend the following free resources:
